...
export class StudentsController {
  ...
  bulkTransfer(
    ...
    return this.studentsService.bulkTransfer(
      studentIds,
      req.user.schoolId,
      gradeName,
      className,
  ...
  changeParentPassword(
    ...
    return this.studentsService.changeParentPassword(
      id,
      req.user.schoolId,
      changePasswordDto,
    );
  ...
  getMyExams(@Request() req) {
    ...
    return this.studentsService.getStudentExamHistory(
      studentId,
      req.user.schoolId,
      req.user,
    );
  ...
  @Roles('SCHOOL_ADMIN', 'TEACHER', 'PARENT', 'STUDENT', 'SUPER_ADMIN')
  @ApiOperation({
    summary: 'Belirli bir öğrencinin deneme sonuçlarını getir (Admin/Öğretmen)',
  })
