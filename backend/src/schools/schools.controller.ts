import { Controller, Get, Param, Put, Body, Post, Delete, UseGuards, Request, Patch, ForbiddenException } from '@nestjs/common';
...
export class SchoolsController {
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles('SCHOOL_ADMIN')
    async updateSchool(@Request() req, @Param('id') id: string, @Body() dto: UpdateSchoolDto) {
        this.assertSchoolAccess(req, id);
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles('SCHOOL_ADMIN', 'TEACHER', 'PARENT')
    async getClasses(@Request() req, @Param('id') id: string, @Param('gradeId') gradeId: string) {
        this.assertSchoolAccess(req, id);
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles('SCHOOL_ADMIN')
    async createClass(@Request() req, @Param('id') id: string, @Body() dto: CreateClassDto) {
        this.assertSchoolAccess(req, id);
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles('SCHOOL_ADMIN')
    async updateClass(@Request() req, @Param('id') id: string, @Param('classId') classId: string, @Body() dto: UpdateClassDto) {
        this.assertSchoolAccess(req, id);
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles('SCHOOL_ADMIN')
    async deleteClass(@Request() req, @Param('id') id: string, @Param('classId') classId: string) {
        this.assertSchoolAccess(req, id);
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles('SCHOOL_ADMIN')
    async mergeClasses(@Request() req, @Param('id') id: string, @Body() dto: MergeClassesDto) {
        this.assertSchoolAccess(req, id);
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles('SCHOOL_ADMIN')
    async transferStudents(@Request() req, @Param('id') id: string, @Param('classId') classId: string, @Body() dto: TransferStudentsDto) {
        this.assertSchoolAccess(req, id);
    ...
    async downloadBackup(@Request() req, @Param('id') id: string, @Param('backupId') backupId: string) {
        this.assertSchoolAccess(req, id);
    ...
    @Roles('SCHOOL_ADMIN', 'SUPER_ADMIN')
    @Post(':id/restore')
    async restoreData(@Request() req, @Param('id') id: string, @Body('backupId') backupId: string) {
        this.assertSchoolAccess(req, id);
    ...
    async deleteBackup(@Request() req, @Param('id') id: string, @Param('backupId') backupId: string) {
        this.assertSchoolAccess(req, id);
    ...
    async restoreFromFile(@Request() req, @Param('id') id: string, @Body('backupData') backupData: any) {
        this.assertSchoolAccess(req, id);
